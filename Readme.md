...
[Website](https://www.ethangrane.com/)
...
| Proyecto | Descripción | Stack |
|---|---|---|
| [Gatto's Pizzeria](https://store.steampowered.com/app/3137770/Gattos_Pizzeria/) | Mi primer juego comercial en Steam es un juego COZY de cocina donde eres un gato pizzero que ha de gestionar un restaurante; el lanzamiento se prevé en inicios de 2027. | C# · GLSL · Unity |
